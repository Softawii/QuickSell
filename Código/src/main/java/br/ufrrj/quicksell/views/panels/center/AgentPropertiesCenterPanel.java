...
public class AgentPropertiesCenterPanel extends JPanel{
    Corretor corretor;
    ...
    public AgentPropertiesCenterPanel(HomeFrame frame) {
        corretor = (Corretor) Sistema.pegarInstancia().getUsuarioAtual();
        this.frame = frame;
    ...
    private void createCenter() {
        ...
        //CenterBody
        if(corretor.getImoveisGerenciados().size() == 0)
        {
            centerBody = new JPanel();
            centerBody.setLayout(new GridBagLayout());
            JLabel warning = new JLabel("Voc\u00EA n\u00E3o tem im\u00F3veis para gerenciar");
            ...
            {
                for(Imovel imovel : corretor.getImoveisGerenciados()){
